...
csv_path = '/workspaces/task_mobile/src/insights/CSV_files/Customer_Usage_Last_12_Months_new.csv'
customer_usage = pd.read_csv(csv_path, sep=';')

customer_usage = customer_usage.rename(columns={
...
customer_usage['Monthly Data Usage (GB)'] = customer_usage['Monthly Data Usage (GB)'].str.replace(',', '.').astype(float)
